...
const CACHE_NAME = 'minha-agenda-v23';
...
const CORE_FILES = [
  ...
  'js/firebase.js', 'js/firebase-config.js', 'js/colors.js', 'js/categories.js',
  'js/pages/home.js', 'js/pages/agenda.js', 'js/pages/tasks.js', 'js/pages/habits.js',
  'js/pages/links.js', 'js/pages/notes.js', 'js/pages/areas.js', 'js/pages/routines.js',
  'js/pages/goals.js', 'js/pages/settings.js',
