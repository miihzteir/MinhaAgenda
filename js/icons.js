...
export const icons = {
  ...
  link: s('<path d="M9 15 15 9"/><path d="M10.5 6.5 12 5a4 4 0 0 1 5.7 5.7l-1.5 1.5"/><path d="M13.5 17.5 12 19a4 4 0 0 1-5.7-5.7l1.5-1.5"/>'),
  sparkle: s('<path d="M12 3c.6 3.5 1.9 4.8 5.4 5.4C13.9 9 12.6 10.3 12 13.8 11.4 10.3 10.1 9 6.6 8.4 10.1 7.8 11.4 6.5 12 3Z"/><path d="M19 14c.3 1.7.9 2.3 2.6 2.6-1.7.3-2.3.9-2.6 2.6-.3-1.7-.9-2.3-2.6-2.6 1.7-.3 2.3-.9 2.6-2.6Z"/>')
};
