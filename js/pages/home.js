  ...
  page.innerHTML = `
    ...
    <div class="summary-card">
      ...
      <div class="stat-row">
        ...
        <div class="stat"><span class="stat-dot" style="background:var(--blush-500)"></span><div><div class="stat-num">${todaysEvents.length}</div><div class="stat-label">eventos hoje</div></div></div>
      </div>
    </div>
