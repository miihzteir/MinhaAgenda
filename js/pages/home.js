...
// vence hoje, ou (sem nenhuma data) sempre — igual sempre funcionou. Exportada
// pra Agenda usar o mesmo critério na Visão do dia (não duplica o filtro).
export function todayTasksFor(d, today) {
...
function draw(page) {
  ...
  const todayTasks = todayTasksFor(d, today);
...
export function openPlanDayModal(todayTasks, today) {
