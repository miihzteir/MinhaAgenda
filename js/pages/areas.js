// Espaços — um lugar pra cada área da vida (Trabalho, Faculdade, Saúde...):
// junta as tarefas, notas e metas daquele contexto numa visão só, com foto de
// capa, descrição e estatísticas. Isso é diferente de Categoria (que é só
// uma etiqueta com cor pra classificar o tipo de item) — um espaço pode até
// ter uma categoria (pra herdar a cor dela), mas os dois são conceitos
