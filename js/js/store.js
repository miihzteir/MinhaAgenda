...
export const store = {
  ...
  // Categoria é usada por eventos, tarefas, hábitos e espaços — ao excluir,
  // tudo que estava nela passa pra primeira categoria que sobrou (eventos
  // sempre precisam de uma; tarefas/hábitos/espaços podem ficar sem).
  deleteCategory(id) {
  ...
  addGoal(g) {
    data.goals.push({
      id: uid(), title: '', description: '', areaId: null, targetDate: null,
