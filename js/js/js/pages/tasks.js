    ...
    <div class="task-row">
      ...
      <div style="flex:1;min-width:0;">
        ...
        <div class="item-meta">
          ...
          ${t.categoryId ? categoryChipHtml(t.categoryId) : ''}
...
export function openTaskModal(existing, defaultDate, defaultAreaId) {
  ...
  openModal({
    ...
    bodyHtml: `
      ...
      <div class="field"><label>Cor</label><div id="f-color-wrap">${colorSwatchesHtml(existing?.color)}</div></div>
      ${areas.length ? `
    ...
    onMount: (body, close) => {
      ...
      // Escolher uma categoria aplica a cor padrão dela — mas a pessoa ainda
      // pode trocar a cor manualmente depois, igual no Google Agenda.
